...
public class ImageRounderPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Graphics2D g2 = (Graphics2D) g.create();// Graphics dikonversi ke Graphics2D
        ...
        // Draw rounded clip
        Shape clip = createRoundShape(w, h); // mengatur area yang diizinkan untuk digambar
        g2.setClip(clip);
